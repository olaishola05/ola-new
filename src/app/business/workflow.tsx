      ...
      <div className="containers mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {workflow.map((phase, idx) => (
            <div key={idx} className="relative">
              <div className="text-6xl font-bold text-[var(--primary)]/10 mb-4">
                {phase.step}
              </div>
        ...
        <div className="mt-16 p-8 bg-gradient-to-br from-[var(--primary)]/5 to-[var(--primary)]/10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {[
              {
                title: "Daily Updates", desc: "Regular Slack/email updates on progress, blockers, and next steps"
              },
              {
                title: "Code Transparency", desc: "All code in GitHub with detailed commit messages and PR descriptions"
              },
              {
                title: "Bi-weekly Demos", desc: "Live demos every 2 weeks to review features and gather feedback"
              }
            ].map((principle, idx) => (
