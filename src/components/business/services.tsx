...
export default function Services() {
  return (
    <section id="services" className="pt-20 md:pt-60 pb-20 px-4 md:px-6" style={{ scrollMarginTop: '80px' }}>
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto animate-stagger">
          {services.map((service, idx) => (
            <Card key={idx} className="bg-[var(--bg)] border hover:border-[var(--primary)] transition-all hover:shadow-xl group">
              <CardHeader>
