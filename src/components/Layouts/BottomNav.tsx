        ...
        {isStartsWith ? (
          ...
          <>
            ...
            >
              ...
              <div
                id="contact"
                className="w-full md:w-10/12 flex flex-col-reverse items-center justify-center md:flex-row-reverse p-4 md:p-6 gap-8 lg:justify-between mt-5 shadow-md rounded-xl"
              >
                <ContactForm />
                  ...
                  <div className="w-full self-center flex flex-col gap-8 md:p-6">
                    <div className="w-full flex flex-col gap-3">
                      ...
                      <p className="text-base text-softText">
                        ...
                        shoot me an email and I will get back to you within 24hrs.
                      </p>
                    </div>

                    <div className="flex flex-col gap-2">
                      <p className="text-base font-semibold flex gap-3">
                        <PhoneCallIcon /> (+234) 8110837448
                      </p>
                      <Link
                        href={`mailto:${process.env.NEXT_PUBLIC_EMAIL}`}
                        className="flex gap-3 font-semibold text-base"
                      >
                        <MailIcon /> Email
                      </Link>
                      <Link
